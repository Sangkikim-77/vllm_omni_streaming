...
def get_vllm_version() -> str:
    ...
    try:
        ...
        # In exported/source-only trees (e.g. .git removed), SCM metadata is
        # unavailable. Fall back to a fixed version so local builds can proceed.
        fallback_version = os.getenv("VLLM_FALLBACK_VERSION", "0.12.0")
        print(
            "setuptools-scm could not detect Git metadata "
