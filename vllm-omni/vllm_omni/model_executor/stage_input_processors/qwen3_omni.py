...
def thinker2talker(
    ...
    for i, thinker_output in enumerate(thinker_outputs):
        ...
        talker_inputs.append(
            OmniTokensPrompt(
                prompt_token_ids=[0] if thinker_embeddings.shape[0]==1 else [0] * _compute_talker_prompt_ids_length(info, device=device),
...
def talker2code2wav(
    ...
    Workflow:
    1. Extract talker's codec code outputs (16-layer RVQ codes)
