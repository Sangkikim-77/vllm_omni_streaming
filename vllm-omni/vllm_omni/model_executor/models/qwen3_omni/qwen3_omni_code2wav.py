...
class Qwen3OmniMoeCode2Wav(nn.Module):
    ...
    def __init__(
        ...
        *,
        ...
        #logger.info(f"🔊 Code2Wav Sampling Rate: {self.config}")
    ...
    def forward(self, codes: torch.Tensor) -> torch.Tensor:
        ...
        """
        #logger.info(f"DEBUG: Code2Wav Input SeqLen: {codes.shape[-1]}")
        ...
        #logger.info(f"DEBUG: Before Conv Blocks Shape: {hidden.shape}")
    ...
    def chunked_decode(
        ...
        return torch.cat(wavs, dim=-1) # [batch, 1, waveform_len]
